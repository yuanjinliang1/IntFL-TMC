...
def parse_args():
    ...
    parser.add_argument('--model-type', default='hybrid',choices=['int','float','hybrid'],
    ...
    parser.add_argument('--grad-bitwidth', default=1, type=int, metavar='N',
                        help='bitwidth of gradient')
    parser.add_argument('--num-clients', default=25, type=int, metavar='N',
                        help='number of selected clients to run in each round')
    # parser.add_argument('--num-clients', default=100, type=int, metavar='N',
    #                     help='number of selected clients to run in each round')
